...
export default function ContactPage() {
  const { contact, socialLinks, emailjsConfig } = portfolioData;
  ...
  const socialConfig: Record<
    string,
    { icon: typeof Github; color: string; gradient: string }
  > = {
    github: {
      icon: Github,
      color: "text-primary",
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 sm:space-y-12 px-1">
      ...
      >
        ...
        <motion.p
          variants={staggerItem}
          className="text-base sm:text-xl text-muted-foreground mx-auto px-4"
        >
      ...
      <div className="grid lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
            ...
            {contact.phone && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium text-sm sm:text-base group-hover:text-cyan transition-colors">
                    {contact.phone}
                  </p>
                </div>
              </motion.a>
              ...
              {socialLinks.map((link) => {
                ...
                return (
                  ...
                  >
                    <Icon
                      className={cn(
                        "h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 group-hover:scale-110 transition-transform",
                        config.color,
                      )}
                    />
        ...
        >
          <form
            ...
            className="glass-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 relative overflow-hidden"
          >
            {/* Decorative gradient */}
      ...
      <div>
        <motion.div
          className="w-[60%] mx-auto glass-card rounded-2xl sm:rounded-3xl p-2 sm:p-4 bg-gradient-to-br from-emerald/5 to-cyan/5 border border-emerald/20"
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            />
            <span className="font-semibold text-sm sm:text-base text-emerald">
