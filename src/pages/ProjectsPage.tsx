...
import { Github, ExternalLink, ArrowUpRight, Folder, Star, Code2 } from 'lucide-react';
...
export default function ProjectsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 sm:space-y-12 px-1">
            ...
            >
              ...
              <div className={cn(
                ...
                <div className={cn(
                  ...
                  {project.highlights.slice(0, isLarge ? 4 : 2).map((highlight, i) => (
                    <motion.div 
                      key={i} 
                    ...
                    >
                      ...
                      <span className="text-xs text-muted-foreground line-clamp-2">{highlight}</span>
                    </motion.div>
                  ))}
                </div>
      ...
      >
        {[
          { value: projects.length + '+', label: 'Projects Built', icon: Folder },
